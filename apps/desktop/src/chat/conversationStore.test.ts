...
const run = (operationId: string, status: DiscussionRun['status'] = 'running'): DiscussionRun => ({ id: `run-${operationId}`, threadId: 'thread-1', owner: { projectId: 'project-1', operationNamespace: 'namespace-1', runId: `run-${operationId}` }, operationId, target: head(), packetId: 'packet-1', previousRunId: null, payloadHash: 'payload', status, dispatchState: 'delivered', sequence: '1', outputText: '', stopReason: null, createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z' });
