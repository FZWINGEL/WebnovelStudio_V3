...
export const ACTIONS = [
  ...
  { id: 'situation', label: 'Put them in a situation', instruction: 'Use ONE explicit shared concrete situation to offer exactly three contrasting tentative choices. Anchor every candidate to that same situation and show commitments and pressure through behavior, not a required trauma or biography. If this involves a relationship, keep both participants present: explore each person’s wants, misunderstandings, what connects them, and what could change without assuming reciprocity.' },
  { id: 'moment', label: 'Try a moment', instruction: 'Use ONE explicit shared concrete situation. Use the SAME situation in two or three short voice treatments, anchoring every candidate to that situation while varying sentence density, viewpoint distance, humor, exposition, or dialogue rhythm. Label all events noncanon experiments. Do not derive adopted guidance or story facts automatically.' },
