...
export const ACTIONS = [
  ...
  { id: 'moment', label: 'Try a moment', instruction: 'Use the SAME situation in three short voice treatments with distinct sentence density, viewpoint distance, humor, exposition, or dialogue rhythm. Label all events noncanon experiments. Do not derive adopted guidance or story facts automatically.' },
