...
export interface PreparedProposal { id: string; proposalId: string; version: string; replacementText: string; paragraphs?: string[]; body: WnsDocument; bodyHash: string }
...
export interface Proposal {
  id: string; runId: string; kind?: 'passage' | 'continuation'; candidate: ProposalCandidate | ContinuationCandidate; source: Head; sourceBody: WnsDocument; scope: ScopeGrant;
