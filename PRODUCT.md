...
Background summary and native Codex maintenance jobs use GPT-5.6 Luna with
xhigh reasoning; configured HTTP Story Memory uses the same Luna/xhigh request
