...
| GitHub/CI | C0–C2, W4 discussions, C3 guidance and recent context pushed | C2, W4, and guidance CI passed all jobs. Recent discussion commit `ec87b76` has green contract jobs and a pending native result in run 33978480373 | Publish retry guidance and record its own remote CI result |
