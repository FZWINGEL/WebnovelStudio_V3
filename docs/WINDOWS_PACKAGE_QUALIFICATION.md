...
The next harness revision reacquires the owned native UIAutomation window during navigation waits and captures bounded owned-window failure diagnostics. A stale automation subtree is a hypothesis until a rerun establishes the cause. Independently, development [run 33988660050](https://github.com/FZWINGEL/WebnovelStudio_V3/actions/runs/33988660050) passed its strict 24-check native flow, including exact chosen-path export and focus restoration.
