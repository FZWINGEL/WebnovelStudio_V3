...
The lookup records use schema 24. The current project reader floor is schema 25
because provider receipts can retain optional observed Codex runtime identity;
