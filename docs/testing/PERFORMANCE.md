...
- **Evidence**: workflow runs `35397231323` (cold opt2 populate), `35400445360` (warm opt2 + source edit), `35403190753` (cold opt0 populate), `35404930115` (warm opt0 + source edit, fully green), `35405936306` (warm opt0, consumer flake at `native-smoke.mjs:790`), `35406859281` (cold opt1 populate, fully green), `35409133320` (warm opt1, fully green) on `FZWINGEL/WebnovelStudio_V3`; `cargo-timings-windows-*` artifacts on each run.
