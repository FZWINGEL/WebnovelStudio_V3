...
Batch Apply, Apply all, ready bundles, reviewed-story continuation, automatic fact activation, and broad provider support remain deferred until a named later gate. If Apply all is enabled later, its contract is all-or-nothing and every member must be validated against the same source.
