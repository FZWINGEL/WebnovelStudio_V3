...
- W6 saved-version History comparison, explicit document restore, lost-acknowledgment recovery, and undo/redo/reopen behavior in the current development slice; and
- strict full-flow clipboard copy/paste coverage, which remains part of the 22-step smoke and is not omitted from CI.
