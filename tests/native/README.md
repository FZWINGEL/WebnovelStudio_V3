...
The latest standard CI run [33992126659](https://github.com/FZWINGEL/WebnovelStudio_V3/actions/runs/33992126659) failed an Ubuntu brief assertion. Package run [33992126374](https://github.com/FZWINGEL/WebnovelStudio_V3/actions/runs/33992126374) failed because its UI Automation lookup timed out even though Chapter was already selected. The bounded fixes are pending fresh hosted reruns; neither failure is presented as a pass.
