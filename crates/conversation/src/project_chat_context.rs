...
pub fn freeze_project_chat_at(
    tx: &Connection,
    request: &wns_story::story_context::FreezeStory,
    payload_hash: &str,
    ...
    wns_story::story_context::freeze_project_chat_at(tx, request, payload_hash, chat)
}
...
mod tests {
    ...
    fn valid_body(text: Option<&str>) -> (String, String) {
        ...
        let validated =
            wns_kernel::validate_snapshot_json(&body.to_string()).expect("valid fixture body");
    ...
    fn forged_control_source_without_project_chat_metadata_is_rejected() {
        ...
        let error = wns_story::story_context::decode_snapshot(
            &json,
            &wns_kernel::sha256_hex(json.as_bytes()),
        )
    ...
    fn edited_ordinary_source_head_is_rejected_before_project_chat_freeze() {
        ...
        let request = wns_story::story_context::FreezeStory {
